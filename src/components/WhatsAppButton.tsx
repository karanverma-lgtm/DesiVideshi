...
export default function WhatsAppButton() {
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#1B998B] text-white shadow-xl hover:bg-[#15786d] focus:outline-none focus:ring-2 focus:ring-[#1B998B] focus:ring-offset-2 md:bottom-8 md:right-8"
